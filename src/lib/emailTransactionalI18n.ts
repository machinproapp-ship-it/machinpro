...
const COPY: Record<TransactionalEmailLang, TransactionalEmailCopy> = {
  ...
  en: {
    welcomeEmailSubject: "Welcome to {company} on MachinPro 🚀",
    welcomeTitle: "Hi {name}, welcome to {company}!",
    welcomeSubtitle: "Your workspace is ready — here is how to get started.",
    welcomeWarm:
      "Thanks for joining MachinPro. Your company workspace ({company}) is live. You can manage teams, projects, schedules, logistics, and safety from web or mobile.",
    welcomeStepsIntro: "Your first steps",
    welcomeStep1: "Complete your profile",
    welcomeStep1Hint: "Settings → Profile",
    welcomeStep2: "Explore your dashboard",
    welcomeStep2Hint: "Central → overview & widgets",
    welcomeStep3: "Clock in for the first time",
    welcomeStep3Hint: "Schedule → My time clock",
