...
const COPY: Record<TransactionalEmailLang, TransactionalEmailCopy> = {
  ...
  en: {
    ...
    welcomeTitle: "Welcome to MachinPro, {name}",
    welcomeSubtitle: "Your account is ready. Start managing your company.",
    welcomeWarm:
      "Thanks for joining MachinPro. You can manage teams, projects, and safety in one place. Your company workspace ({company}) is live.",
    welcomeStepsIntro: "Your first steps",
    welcomeStep1: "Set up your company",
    welcomeStep1Hint: "In the app: Settings → Company",
    welcomeStep2: "Invite your team",
    welcomeStep2Hint: "In the app: Employees",
    welcomeStep3: "Create your first project",
    welcomeStep3Hint: "In the app: Projects",
    welcomeCta: "Sign in to MachinPro",
